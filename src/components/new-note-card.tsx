...
export function NewNoteCard({onNoteCreated}: NewNoteCardProps) {
  ...
  function handleStartRecording() {
    const isSpeechRecognitonAPIAvailable = 'SpeechRecognition' in window
                ...
                <div className='flex flex-1 flex-col p-5 gap-3'>
                  ...
                  {shouldShowOnBoarding ? (
                    ...
                    <p>
                      <textarea 
                      autoFocus 
                      className='w-full text-sm leading-6 text-slate-480 bg-transparent resize-none flex-1 outline-none' 
